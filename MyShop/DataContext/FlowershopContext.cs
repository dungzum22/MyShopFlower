...
public partial class FlowershopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__CAA247C85DF418C1");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__2EF52A27AE475885");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__D54EE9B4F2DED955");
        ...
        {
            entity.HasKey(e => e.FlowerId).HasName("PK__Flower_I__177E0A7E28C2940B");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Messages__0BBF6EE62F82D773");
            ...
            entity.HasOne(d => d.Recipient).WithMany(p => p.MessageRecipients)
                ...
                .HasConstraintName("FK__Messages__recipi__7C4F7684");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__46596229EDB2EE68");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Orders)
                ...
                .HasConstraintName("FK__Orders__address___01142BA1");

            entity.HasOne(d => d.Cart).WithMany(p => p.Orders)
                .HasForeignKey(d => d.CartId)
                .HasConstraintName("FK__Orders__cart_id__02084FDA");

            entity.HasOne(d => d.User).WithMany(p => p.Orders)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Orders__user_id__00200768");
        });

        modelBuilder.Entity<OrdersDetail>(entity =>
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__Orders_D__3C5A4080366F015E");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.OrdersDetails)
                .HasForeignKey(d => d.AddressId)
                .HasConstraintName("FK__Orders_De__addre__09A971A2");

            entity.HasOne(d => d.Flower).WithMany(p => p.OrdersDetails)
                .HasForeignKey(d => d.FlowerId)
                .HasConstraintName("FK__Orders_De__flowe__07C12930");

            entity.HasOne(d => d.Order).WithMany(p => p.OrdersDetails)
                .HasForeignKey(d => d.OrderId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__Orders_De__order__06CD04F7");

            entity.HasOne(d => d.Seller).WithMany(p => p.OrdersDetails)
                .HasForeignKey(d => d.SellerId)
                .HasConstraintName("FK__Orders_De__selle__08B54D69");

            entity.HasOne(d => d.UserVoucherStatus).WithMany(p => p.OrdersDetails)
                .HasForeignKey(d => d.UserVoucherStatusId)
                .HasConstraintName("FK__Orders_De__user___0A9D95DB");
        });

        modelBuilder.Entity<Report>(entity =>
        {
            entity.HasKey(e => e.ReportId).HasName("PK__Report__779B7C58F125AD61");
            ...
            entity.HasOne(d => d.Flower).WithMany(p => p.Reports)
                .HasForeignKey(d => d.FlowerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Report__flower_i__74AE54BC");

            entity.HasOne(d => d.Seller).WithMany(p => p.Reports)
                .HasForeignKey(d => d.SellerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Report__seller_i__75A278F5");

            entity.HasOne(d => d.User).WithMany(p => p.Reports)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Report__user_id__73BA3083");
        });

        modelBuilder.Entity<Seller>(entity =>
        {
            entity.HasKey(e => e.SellerId).HasName("PK__Seller__780A0A97543D71A9");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370F54C0669B");

            entity.HasIndex(e => e.Username, "UQ__Users__F3DBC5720391BBE4").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserInfoId).HasName("PK__User_Inf__82ABEB544C275E13");
        ...
        {
            entity.HasKey(e => e.UserVoucherStatusId).HasName("PK__User_Vou__6804F51CE68CFD54");
